...
class CustomSidebarViewProvider {
            ...
            setInterval(() => {
                ...
                if (nerr > 0 && nerr <= 5) {
                    if (flag2) {
                        ...
                        value ? (0, player_1.cry)() : null;
                        flag1 = true;
                        flag2 = false, flag3 = true, flag4 = true;
                    }
                    else {
                ...
                if (nerr > 5 && nerr <= 10) {
                    if (flag3) {
                        ...
                        value ? (0, player_1.ambu)() : null;
                        flag1 = true;
                        flag2 = true, flag3 = false, flag4 = true;
                    }
                    else {
                ...
                if (nerr > 10) {
                    if (flag4) {
                        ...
                        value ? (0, player_1.dead)() : null;
                        flag1 = true;
                        flag2 = true, flag3 = true, flag4 = false;
                    }
                    else {
    ...
    getHtmlContent(webview, cat) {
        const catUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "assets", cat));
        return (cat === "intro.gif") ? introHtml(catUri) : getHtml(catUri);
    }
}
CustomSidebarViewProvider.viewType = "catverse.openview";
function getHtml(cat) {
    return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
